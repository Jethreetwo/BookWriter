...
1. Run Ollama in the background. Program uses Llama3.1:8b since it can run lightweight on an old Mac laptop and also is the target of copyright infringement litigation against Meta.
   ```
   pip install ollama
